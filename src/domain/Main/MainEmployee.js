...
const Main = () => {
    return(
        <div className="center">
            ...
            <a className="without-background" href="http://google.com"><img src="https://image.flaticon.com/icons/png/512/2421/2421989.png" class="smaller-image"></img></a>
            ...
            <a className="without-background" href="http://google.com"><img src="https://image.flaticon.com/icons/png/512/1019/1019607.png" class="smaller-image"></img></a>
            <a className="without-background" href="http://google.com"><img src="https://image.flaticon.com/icons/png/512/3143/3143218.png" class="smaller-image"></img></a>
